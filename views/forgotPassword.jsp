...
<body id="body">
	...
	<!--Card begins here-->
		...
		<div class="col col-md-offset-2 col-md-7" style="margin-left: 200px;">
			...
			<!-- Form begins here!-->
				<c:url var="checkEmail" value="/user/checkEmail/"></c:url>
				<form:form method="post"  modelAttribute="forgotPassword" action="${checkEmail}">
				
				
				<!-- Condition Checker Begins -->
			
				<c:if test="${noEmail eq true }">
					<div class="form-group">
						<div class="alert alert-danger alert-dismissible">
							<button type="button" class="close" data-dismiss="alert">&times;</button>
							<strong>Error!</strong> Email Id doesn't exist.
			...
			<!-- Condition Checker Begins -->
					...
					<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<form:input path="emailId" type="email" class="form-control" required="required" />
										</div>
									</div>
				...
				<form:form method="post" modelAttribute="userHint2" action="${verifyHint}">
				
				<c:if test="${addNewPassword eq false }">
				<div class="form-group">
						<div class="alert alert-danger alert-dismissible">
							<button type="button" class="close" data-dismiss="alert">&times;</button>
